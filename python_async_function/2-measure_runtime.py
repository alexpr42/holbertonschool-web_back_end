...
async def wait_n(n: int, max_delay: int) -> List[float]:
    """Async function that spawns n wait_random coroutines
...
def measure_time(n: int, max_delay: int) -> float:
    """
    Measures the total execution time for the wait_n
    ...
    asyncio.run(wait_n(n, max_delay))  # Execute wait_n and wait for it
